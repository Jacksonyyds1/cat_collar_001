...
typedef enum {
  ...
  WIFI_STATE_RECONNECT_PENDING
} wifi_internal_state_t;

static volatile wifi_internal_state_t wifi_internal_state = WIFI_STATE_IDLE;
...
extern bsp_wifi_info_t device_access_point_info;
